...
class SchemaParser {
    ...
    static putChildToSchemaNode(schemaNode, child, defNamespace) {
        // Obtenemos name y namespace
        ...
        const schemaChild = new ChildDefinition_1.ChildDefinition(name, namespace, this.getInteger(child, "min"), this.getInteger(child, "max"), child.getLine());
        schemaNode.addChildDefinition(schemaChild);
    }
    static getInteger(node, name) {

...
STXT is a plain-text language for structured documents: no braces, no closing tags, just indentation, with an optional schema layer so documents can be validated.

More information: [https://stxt.dev](https://stxt.dev)
Ready-to-use examples: [https://github.com/stxt-lang/stxt-lang](https://github.com/stxt-lang/stxt-lang)
